                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Específicos</a>
                                </li>
                                <!-- <li class="nav-item">
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" v-model="modelo" id="modelo" class="form-control" placeholder="Modelo" onblur="document.getElementById('codigo_interno').value=this.value"> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" v-model="codigo_interno" id="codigo_interno" class="form-control" placeholder="Código interno"> 
                                        </div>
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="text-input">Código Interno</label>
                                <div class="col-md-9">
                                    <input type="text" v-model="codigo_interno" class="form-control" placeholder="Código interno"> 
                                </div>
                            </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            selectCategoria(){
                let me=this;
                var url= '/category/selectCategoria';
                axios.get(url).then(function (response) {
