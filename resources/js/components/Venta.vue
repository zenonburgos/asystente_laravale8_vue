                    ...
                    <div class="form-group row border">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" value="0" class="form-control form-control-sm" v-model="descuento" style="border-radius: 5px;">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody v-if="arrayDetalle.length">
                                    <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                        ...
                                        <td>
                                            <input v-model="detalle.precio" type="number" class="form-control form-control-sm" style="border: 0;">
                                        </td>
                                        <td>
                                            <span style="color:red;" v-show="detalle.cantidad>detalle.stock">Stock: {{detalle.stock}}</span>
                                            <input v-model="detalle.cantidad" type="number" class="form-control form-control-sm" style="border: 0;">
                                        </td>
                                        <td>
                                            <span style="color:red;" v-show="detalle.descuento>(detalle.precio*detalle.cantidad)">Descuento superior{{detalle.stock}}</span>
                                            <input v-model="detalle.descuento" type="number" class="form-control form-control-sm" style="border: 0;">
                                        </td>
                                        <td align="right">
        ...
        methods : {
            listarVenta (page,buscar,criterio){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arrayVenta = respuesta.ventas.data; //ingresos viene del controlador IngresoController: $ingresos
            ...
            validarVenta(){
                ...
                if (me.idcliente==0) me.errorMostrarMsjVenta.push("Seleccione un cliente" + me.idproveedor);
